...
class Backbone(nn.Module):
    ...
    def forward(self, x1):
        ...
        x1 = self.backbone(x1)
        x1_1 = self.up0(self.Translayer0(x1[0]))
...
class SptialCNN(nn.Module):
    def __init__(self, ):
        ...
        self.up = nn.Upsample(scale_factor=4, mode='bilinear', align_corners=True)
        self.cov_diff1 = CBAM(channel=512)
        self.cov_diff = self._make_layer(ResBlock, 512, 64, 1, stride=1)
    ...
    def forward(self, x_list):
        ...
        print(features1.shape)
        diff1 = (torch.abs(features1 - features2))
        diff2 = (torch.abs(features2 - features3))
        diff = self.cov_diff(self.cov_diff1(torch.cat([diff1, diff2],dim=1)))
...
class CSTMNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=2):
        ...
        self.classifier_bcd = nn.Conv2d(64, 4, kernel_size=3, padding=1)
    ...
    def forward(self, x_1,x_2,x_3):
        ...
        features1,features2,features3,diff = self.Sptial([x_1,x_2,x_3])
        semantic_moments = []
